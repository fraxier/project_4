...
ActiveRecord::Schema[7.0].define(version: 20_221_105_053_706) do
  ...
  create_table 'artists_events', id: false, force: :cascade do |t|
    ...
    t.index %w[artist_id event_id], name: 'index_artists_events_on_artist_id_and_event_id', unique: true
  end
